"""
Automated Pytest for parenteral-nutrition-tpn-agent Enrichment Modules.
"""
import sys
...
from enrichment import (
    ...
    ParenteralnutritiontpnagentEnrichmentSuite,
    enrichment_suite,
)

def test_enrichment_suite_execution():
    suite = ParenteralnutritiontpnagentEnrichmentSuite()
