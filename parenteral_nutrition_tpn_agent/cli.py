"""
Command-Line Interface for TPN-Prescriber: Total Parenteral Nutrition (TPN) Macro/Micro & Refeeding Agent.
"""
import argparse
import csv
import json
...
def main(argv=None):
    ...
    if args.command == "audit":
        ...
        print(f"  Domain: Clinical Nutrition | Standard: ASPEN / ESPEN Parenteral Nutrition Standards")
