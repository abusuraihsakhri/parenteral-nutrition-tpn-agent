...
**Parenteral Nutrition Tpn Agent** is an advanced analytical and computational platform implementing TPN Macronutrient, Osmolarity & Refeeding Syndrome Prophylaxis.
...
- **`CaloricMacronutrientAgent`**: Specialized Sub-Agent 1 for parenteral-nutrition-tpn-agent
- **`RefeedingSyndromeAuditorAgent`**: Specialized Sub-Agent 2 for parenteral-nutrition-tpn-agent
- **`OsmolarityPeripheralCentralAgent`**: Specialized Sub-Agent 3 for parenteral-nutrition-tpn-agent
...
docker run -p 8000:8000 parenteral-nutrition-tpn-agent
```
